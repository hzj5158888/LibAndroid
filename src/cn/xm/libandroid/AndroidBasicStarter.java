...
public class AndroidBasicStarter extends ListActivity {
	...
	private String tests[] = { "AccelerometerTest", "AssetTest", "BitmapTest", "ConnectivityServiceTest", "DirectoryServiceTest", "ExternalStorageTest", "FontTest", "FullScreenTest", "KeyTest", "LifeCycleTest", "MediaPlayerTest", "MultiTouchTest", "NotificationServiceTest", "RenderViewTest", "ScreenResolution", "ShapeTest", "SharedPreferencesTest", "SingleTouchTest", "SoundPoolTest", "SurfaceViewTest", "WifiServiceTest" };
...
//		 this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);
	...
	protected void onListItemClick(ListView list, View view, int position, long id) {
		...
		try {
			Class<?> clazz = Class.forName("cn.xm.yss.testcase." + testName);
